 ...
 * @version 2012.02.27
 */
public class BPxMLL extends MultiLabelLearnerBase {
    ...
    private double weightsDecayCost = 0.000001;
     ...
     */
    public BPxMLL(long randomnessSeed) {
    ...
    protected void buildInternal(final MultiLabelInstances instances) throws Exception {
        ...
        BPxMLLAlgorithm learnAlg = new BPxMLLAlgorithm(model, weightsDecayCost);
